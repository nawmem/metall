...
@section('content')
    ...
    <div class="mb-4 p-4 border-2 border-dashed rounded-md border-neutral-300">
        ...
        <div>
            <div>
                <p>
                    <a class="text-blue-500 hover:text-blue-800" href="{{ route('createStatMetallCategories') }}">Смотреть статистику по категориям</a>
                </p>
            </div>
        ...
        @isset($is_categories)
            <div>
                <p>
                    <a class="text-blue-500 hover:text-blue-800" href="{{ route('createStatMetall') }}">Вернуться назад</a>
                </p>
            </div>
                <div>
                    <div class="flex flex-col">
